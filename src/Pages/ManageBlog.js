        ...
        <>
            <div className="content">
                <div className="container-fluid">
                    <h4 className="page-title">Quản lý blog</h4>
                    <div className="row">
                                        ...
                                        <tbody>
                                            {records.filter((blog) => {
                                                ...
                                                <tr key={blog.id}>
                                                    ...
                                                    <td>
                                                        <Link to={`/blogdetail/${blog.id}`} class="btn btn-success mr-2" onClick={DetailClick}>Chi tiết</Link>
                                                        <button class="btn btn-danger" onClick={() => deleteBlog(blog.id)}>Xóa</button>
                                                    </td>
                                                </tr>
                                            ))}
                                        </tbody>
