...
import { collection, getDocs, query, where, onSnapshot, deleteDoc, doc, getDoc } from 'firebase/firestore';
        ...
        <>
            <div className="content">
                <div className="container-fluid">
                    <h4 className="page-title">Quản lý công thức món ăn</h4>
                    <div className="row">
                                        ...
                                        <tbody>
                                            {records.filter((food) => {
                                                ...
                                                <tr key={food.id}>
                                                    ...
                                                    <td>
                                                        <Link to={`/fooddetail/${food.id}`} class="btn btn-success mr-2" onClick={DetailClick}>Chi tiết</Link>
                                                        <button class="btn btn-danger" onClick={() => deleteFood(food.id)}>Xóa</button>
                                                    </td>
                                                </tr>
                                            ))}
                                        </tbody>
